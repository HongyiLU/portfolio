...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ss(e,t,n){return new ya({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ko,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cs(){return new ya({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ls(){return new ya({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:us(),fragmentShader:`
	...
	`}var ds=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ti(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ic={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Lc(e,t){let n=Ic[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Rc=new U;function zc(){return It.getLuminanceCoefficients(Rc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Rc.x.toFixed(4)}, ${Rc.y.toFixed(4)}, ${Rc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
}`,Bl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ki(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new ya({vertexShader:Rl,fragmentShader:zl,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new q(new oa(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Vl=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,f=null,p=null,m=null,h=typeof XRWebGLBinding<`u`,_=new Bl,v={},y=t.getContextAttributes(),b=null,S=null,C=[],w=[],T=new H,k=null,A=null,j=new ro;j.viewport=new qt;let ee=new ro;ee.viewport=new qt;let te=[j,ee],M=new uo,ne=null,N=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getHandSpace()};function re(e){let t=w.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,re),r.removeEventListener(`selectstart`,re),r.removeEventListener(`selectend`,re),r.removeEventListener(`squeeze`,re),r.removeEventListener(`squeezestart`,re),r.removeEventListener(`squeezeend`,re),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=w[e];t!==null&&(w[e]=null,C[e].disconnect(t))}ne=null,N=null,_.reset();for(let e in v)delete v[e];if(e.setRenderTarget(b),p=null,f=null,u=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(k),e.setSize(T.width,T.height,!1),A!==null){let e=A.camera;e.fov=A.fov,e.zoom=A.zoom,e.updateProjectionMatrix(),A=null}n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return u===null&&h&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return m},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(b=e.getRenderTarget(),r.addEventListener(`select`,re),r.addEventListener(`selectstart`,re),r.addEventListener(`selectend`,re),r.addEventListener(`squeeze`,re),r.addEventListener(`squeezestart`,re),r.addEventListener(`squeezeend`,re),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),y.xrCompatible!==!0&&await t.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(T),h&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;y.depth&&(o=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=y.stencil?O:D,a=y.stencil?x:g);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),f=u.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Yt(f.textureWidth,f.textureHeight,{format:E,type:d,depthTexture:new Di(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Yt(p.framebufferWidth,p.framebufferHeight,{format:E,type:d,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1,storeMultisampledDepthBuffer:p.ignoreDepthValues===!1,storeMultisampledStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=w.indexOf(n);r>=0&&(w[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=w.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=w.length){w.push(n),r=e;break}else if(w[e]===null){w[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new U,se=new U;function ce(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function le(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),M.near=ee.near=j.near=t,M.far=ee.far=j.far=n,(ne!==M.near||N!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),ne=M.near,N=M.far),M.layers.mask=e.layers.mask|6,j.layers.mask=M.layers.mask&-5,ee.layers.mask=M.layers.mask&-3;let i=e.parent,a=M.cameras;le(M,i);for(let e=0;e<a.length;e++)le(a[e],i);a.length===2?ce(M,j,ee):M.projectionMatrix.copy(j.projectionMatrix),A===null&&e.isPerspectiveCamera&&(A={camera:e,fov:e.fov,zoom:e.zoom}),P(e,M,i)};function P(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ot*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(f!==null||p!==null)return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(M)},this.getCameraTexture=function(e){return v[e]};let ue=null;function de(t,i){if(l=i.getViewerPose(c||a),m=i,l!==null){let t=l.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==M.cameras.length&&(M.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=u.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=te[n];o===void 0&&(o=new ro,o.layers.enable(n),o.viewport=new qt,te[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(M.matrix.copy(o.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),i===!0&&M.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&h){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&h){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new ki,v[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=w[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ue&&ue(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),m=null}let fe=new No;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){ue=e},this.dispose=function(){}}},Hl=new Qt,Ul=new W;Ul.set(-1,0,0,0,1,0,0,0,1);function Wl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,ha(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Hl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Ul),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.retroreflectivity>0&&(e.retroreflectivity.value=t.retroreflectivity),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Gl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return B(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?z(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):z(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var Kl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),ql=null;function Jl(){return ql===null&&(ql=new bi(Kl,16,16,j,v),ql.name=`DFG_LUT`,ql.minFilter=c,ql.magFilter=c,ql.wrapS=r,ql.wrapT=r,ql.generateMipmaps=!1,ql.needsUpdate=!0),ql}var Yl=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:p=!1,outputBufferType:h=d}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);_=n.getContextAttributes().alpha}else _=a;let S=h,C=new Set([te,ee,A]),w=new Set([d,g,m,x,y,b]),T=new Uint32Array(4),E=new Int32Array(4),D=new U,O=null,k=null,j=[],M=[],ne=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let N=this,re=!1,ie=null,ae=null,oe=null,se=null;this._outputColorSpace=ze;let ce=0,le=0,P=null,ue=-1,de=null,fe=new qt,pe=new qt,me=null,he=new K(0),ge=0,_e=t.width,ve=t.height,ye=1,be=null,xe=null,Se=new qt(0,0,_e,ve),Ce=new qt(0,0,_e,ve),we=!1,Te=new wi,Ee=!1,De=!1,Oe=new Qt,ke=new U,Ae=new qt,je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Me=!1;function Ne(){return P===null?ye:1}let F=n;function Pe(e,n){return t.getContext(e,n)}let Fe,Ie,I,Le,L,R,Re,Be,Ve,He,Ue,We,Ke,qe,Je,Xe,Qe,$e,tt,nt,rt,it,at;try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:f};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r186`),t.addEventListener(`webglcontextlost`,V,!1),t.addEventListener(`webglcontextrestored`,ct,!1),t.addEventListener(`webglcontextcreationerror`,lt,!1),F===null){let t=`webgl2`;if(F=Pe(t,e),F===null)throw Pe(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}ot()}catch(e){throw t.removeEventListener(`webglcontextlost`,V,!1),t.removeEventListener(`webglcontextrestored`,ct,!1),t.removeEventListener(`webglcontextcreationerror`,lt,!1),B(`WebGLRenderer: `+e.message),e}function ot(){Fe=new ps(F),Fe.init(),rt=new Ll(F,Fe),Ie=new Ho(F,Fe,e,rt),I=new Fl(F,Fe),Ie.reversedDepthBuffer&&p&&I.buffers.depth.setReversed(!0),ae=F.createFramebuffer(),oe=F.createFramebuffer(),se=F.createFramebuffer(),Le=new gs(F),L=new hl,R=new Il(F,Fe,I,L,Ie,rt,Le),Re=new fs(N),Be=new Po(F),it=new Bo(F,Be),Ve=new ms(F,Be,Le,it),He=new vs(F,Ve,Be,it,Le),$e=new _s(F,Ie,R),Je=new Uo(L),Ue=new ml(N,Re,Fe,Ie,it,Je),We=new Wl(N,L),Ke=new yl,qe=new El(Fe),Qe=new zo(N,Re,I,He,_,s),Xe=new Pl(N,He,Ie),at=new Gl(F,Le,Ie,I),tt=new Vo(F,Fe,Le),nt=new hs(F,Fe,Le),Le.programs=Ue.programs,N.capabilities=Ie,N.extensions=Fe,N.properties=L,N.renderLists=Ke,N.shadowMap=Xe,N.state=I,N.info=Le}S!==1009&&(ne=new bs(S,t.width,t.height,o,r,i));let st=new Vl(N,F);this.xr=st,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let e=Fe.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Fe.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ye},this.setPixelRatio=function(e){e!==void 0&&(ye=e,this.setSize(_e,ve,!1))},this.getSize=function(e){return e.set(_e,ve)},this.setSize=function(e,n,r=!0){if(st.isPresenting){z(`WebGLRenderer: Can't change size while VR device is presenting.`);return}_e=e,ve=n,t.width=Math.floor(e*ye),t.height=Math.floor(n*ye),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ne!==null&&ne.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(_e*ye,ve*ye).floor()},this.setDrawingBufferSize=function(e,n,r){_e=e,ve=n,ye=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){B(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){z(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ne.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(fe)},this.getViewport=function(e){return e.copy(Se)},this.setViewport=function(e,t,n,r){e.isVector4?Se.set(e.x,e.y,e.z,e.w):Se.set(e,t,n,r),I.viewport(fe.copy(Se).multiplyScalar(ye).round())},this.getScissor=function(e){return e.copy(Ce)},this.setScissor=function(e,t,n,r){e.isVector4?Ce.set(e.x,e.y,e.z,e.w):Ce.set(e,t,n,r),I.scissor(pe.copy(Ce).multiplyScalar(ye).round())},this.getScissorTest=function(){return we},this.setScissorTest=function(e){I.setScissorTest(we=e)},this.setOpaqueSort=function(e){be=e},this.setTransparentSort=function(e){xe=e},this.getClearColor=function(e){return e.copy(Qe.getClearColor())},this.setClearColor=function(){Qe.setClearColor(...arguments)},this.getClearAlpha=function(){return Qe.getClearAlpha()},this.setClearAlpha=function(){Qe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(P!==null){let t=P.texture.format;e=C.has(t)}if(e){let e=P.texture.type,t=w.has(e),n=Qe.getClearColor(),r=Qe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,F.clearBufferuiv(F.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,F.clearBufferiv(F.COLOR,0,E))}else r|=F.COLOR_BUFFER_BIT}t&&(r|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&F.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ie=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,V,!1),t.removeEventListener(`webglcontextrestored`,ct,!1),t.removeEventListener(`webglcontextcreationerror`,lt,!1),Qe.dispose(),Ke.dispose(),qe.dispose(),L.dispose(),Re.dispose(),He.dispose(),it.dispose(),at.dispose(),Ue.dispose(),st.dispose(),st.removeEventListener(`sessionstart`,gt),st.removeEventListener(`sessionend`,_t),vt.stop()};function V(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),re=!0}function ct(){Ze(`WebGLRenderer: Context Restored.`),re=!1;let e=Le.autoReset,t=Xe.enabled,n=Xe.autoUpdate,r=Xe.needsUpdate,i=Xe.type;ot(),Le.autoReset=e,Xe.enabled=t,Xe.autoUpdate=n,Xe.needsUpdate=r,Xe.type=i}function lt(e){B(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ut(e){let t=e.target;t.removeEventListener(`dispose`,ut),dt(t)}function dt(e){ft(e),L.remove(e)}function ft(e){let t=L.get(e).programs;t!==void 0&&(t.forEach(function(e){Ue.releaseProgram(e)}),e.isShaderMaterial&&Ue.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=je);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Ot(e,t,n,r,i);I.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ve.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;it.setup(i,r,s,n,c);let h,g=tt;if(c!==null&&(h=Be.get(c),g=nt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(I.setLineWidth(r.wireframeLinewidth*Ne()),g.setMode(F.LINES)):g.setMode(F.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),I.setLineWidth(e*Ne()),i.isLineSegments?g.setMode(F.LINES):i.isLineLoop?g.setMode(F.LINE_LOOP):g.setMode(F.LINE_STRIP)}else i.isPoints?g.setMode(F.POINTS):i.isSprite&&g.setMode(F.TRIANGLES);if(i.isBatchedMesh){if(Fe.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Be.get(c).bytesPerElement:1,o=L.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(F,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function pt(e,t,n,r){ie!==null&&e.isNodeMaterial&&ie.setObject(r,e),Ee===!0&&Je.setState(e,n,!1),e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,wt(e,t,r),e.side=0,e.needsUpdate=!0,wt(e,t,r),e.side=2):wt(e,t,r)}this.compile=function(e,t,n=null){n===null&&(n=e),ie!==null&&ie.renderStart(e,t,n),k=qe.get(n),k.init(t),M.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights(),ie!==null&&ie.updateLights(k.state.lightsArray),De=this.localClippingEnabled,Ee=Je.init(this.clippingPlanes,De),Ee===!0&&Je.setGlobalState(this.clippingPlanes,t),ie!==null&&Xe.render(k.state.shadowsArray,n,t);let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let i=e.material;if(i){if(Array.isArray(i))for(let a=0;a<i.length;a++){let o=i[a];pt(o,n,t,e),r.add(o)}else pt(i,n,t,e),r.add(i)}}),k=M.pop(),ie!==null&&ie.renderEnd(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){let t=L.get(e).currentProgram;(t===void 0||t.isReady())&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Fe.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let mt=null;function ht(e){mt&&mt(e)}function gt(){vt.stop()}function _t(){vt.start()}let vt=new No;vt.setAnimationLoop(ht),typeof self<`u`&&vt.setContext(self),this.setAnimationLoop=function(e){mt=e,st.setAnimationLoop(e),e===null?vt.stop():vt.start()},st.addEventListener(`sessionstart`,gt),st.addEventListener(`sessionend`,_t),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){B(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(re===!0)return;ie!==null&&ie.renderStart(e,t);let n=st.enabled===!0&&st.isPresenting===!0,r=ne!==null&&(P===null||n)&&ne.begin(N,P);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),st.enabled===!0&&st.isPresenting===!0&&(ne===null||ne.isCompositing()===!1)&&(st.cameraAutoUpdate===!0&&st.updateCamera(t),t=st.getCamera()),e.isScene===!0&&e.onBeforeRender(N,e,t,P),k=qe.get(e,M.length),k.init(t),k.state.textureUnits=R.getTextureUnits(),M.push(k),Oe.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Te.setFromProjectionMatrix(Oe,Ge,t.reversedDepth),De=this.localClippingEnabled,Ee=Je.init(this.clippingPlanes,De),O=Ke.get(e,j.length),O.init(),j.push(O),st.enabled===!0&&st.isPresenting===!0){let e=N.xr.getDepthSensingMesh();e!==null&&yt(e,t,-1/0,N.sortObjects)}yt(e,t,0,N.sortObjects),O.finish(),ie!==null&&ie.updateLights(k.state.lightsArray),N.sortObjects===!0&&O.sort(be,xe),Me=st.enabled===!1||st.isPresenting===!1||st.hasDepthSensing()===!1,Me&&Qe.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ee===!0&&Je.beginShadows();let i=k.state.shadowsArray;if(Xe.render(i,e,t),Ee===!0&&Je.endShadows(),(r&&ne.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];xt(n,r,e,a)}Me&&Qe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];bt(O,e,n,n.viewport)}}else r.length>0&&xt(n,r,e,t),Me&&Qe.render(e),bt(O,e,t)}P!==null&&le===0&&(R.updateMultisampleRenderTarget(P),R.updateRenderTargetMipmap(P)),r&&ne.end(N),e.isScene===!0&&e.onAfterRender(N,e,t),it.resetDefaultState(),ue=-1,de=null,M.pop(),M.length>0?(k=M[M.length-1],R.setTextureUnits(k.state.textureUnits),Ee===!0&&Je.setGlobalState(N.clippingPlanes,k.state.camera)):k=null,j.pop(),O=j.length>0?j[j.length-1]:null,ie!==null&&ie.renderEnd()};function yt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||e.intersectsFrustum(Te)){r&&Ae.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Oe);let i=He.update(e),a=e.material;a.visible&&O.push(e,i,a,n,Ae.z,null,t)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||e.intersectsFrustum(Te))){let i=He.update(e),a=e.material;if(r&&(e.boundingSphere===void 0?(i.boundingSphere===null&&i.computeBoundingSphere(),Ae.copy(i.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Ae.copy(e.boundingSphere.center)),Ae.applyMatrix4(e.matrixWorld).applyMatrix4(Oe)),Array.isArray(a)){let r=i.groups;for(let o=0,s=r.length;o<s;o++){let s=r[o],c=a[s.materialIndex];c&&c.visible&&O.push(e,i,c,n,Ae.z,s,t)}}else a.visible&&O.push(e,i,a,n,Ae.z,null,t)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)yt(i[e],t,n,r)}function bt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Ee===!0&&Je.setGlobalState(N.clippingPlanes,n),r&&I.viewport(fe.copy(r)),i.length>0&&St(i,t,n),a.length>0&&St(a,t,n),o.length>0&&St(o,t,n),I.buffers.depth.setTest(!0),I.buffers.depth.setMask(!0),I.buffers.color.setMask(!0),I.setPolygonOffset(!1)}function xt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Fe.has(`EXT_color_buffer_half_float`)||Fe.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Yt(1,1,{generateMipmaps:!0,type:e?v:d,minFilter:u,samples:Math.max(4,Ie.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:It.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||fe;a.setSize(o.z*N.transmissionResolutionScale,o.w*N.transmissionResolutionScale);let s=N.getRenderTarget(),c=N.getActiveCubeFace(),l=N.getActiveMipmapLevel();N.setRenderTarget(a),N.getClearColor(he),ge=N.getClearAlpha(),ge<1&&N.setClearColor(16777215,.5),N.clear(),Me&&Qe.render(n);let f=N.toneMapping;N.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Ee===!0&&Je.setGlobalState(N.clippingPlanes,r),St(e,n,r),R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a),Fe.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,Ct(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a))}N.setRenderTarget(s,c,l),N.setClearColor(he,ge),p!==void 0&&(r.viewport=p),N.toneMapping=f}function St(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&Ct(o,t,n,s,l,c)}}function Ct(e,t,n,r,i,a){ie!==null&&i.isNodeMaterial&&ie.setObject(e,i),e.onBeforeRender(N,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(N,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,N.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,N.renderBufferDirect(n,t,r,i,e,a),i.side=2):N.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(N,t,n,r,i,a)}function wt(e,t,n){t.isScene!==!0&&(t=je);let r=L.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ue.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ue.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Re.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ut),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Et(e,s),d}else s.uniforms=Ue.getUniforms(e),ie!==null&&e.isNodeMaterial&&ie.build(e,n,s),e.onBeforeCompile(s,N),d=Ue.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Je.uniform),Et(e,s),r.needsLights=kt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.sunLights.value=i.state.sun,f.sunLightShadows.value=i.state.sunShadow,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.sunShadowMatrix.value=i.state.sunShadowMatrix,f.sunShadowCascade.value=i.state.sunShadowCascade,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Tt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Dc.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Et(e,t){let n=L.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Dt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Ot(e,t,n,r,i){t.isScene!==!0&&(t=je),R.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=P===null?N.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:It.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Re.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(h=N.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=L.get(r),y=k.state.lights;if(Ee===!0&&(De===!0||e!==de)){let t=e===de&&r.id===ue;Je.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i._colorsTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i._colorsTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Je.numPlanes||v.numIntersection!==Je.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=wt(r,t,i),ie&&r.isNodeMaterial&&ie.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(I.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ue&&(ue=r.id,C=!0),v.needsLights){let e=Dt(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||de!==e){I.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(F,`projectionMatrix`,e.projectionMatrix),T.setValue(F,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(F,ke.setFromMatrixPosition(e.matrixWorld)),Ie.logarithmicDepthBuffer&&T.setValue(F,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(F,`isOrthographic`,e.isOrthographicCamera===!0),de!==e&&(de=e,C=!0,w=!0)}if(v.needsLights&&(y.state.sunShadowMap.length>0&&T.setValue(F,`sunShadowMap`,y.state.sunShadowMap,R),y.state.directionalShadowMap.length>0&&T.setValue(F,`directionalShadowMap`,y.state.directionalShadowMap,R),y.state.spotShadowMap.length>0&&T.setValue(F,`spotShadowMap`,y.state.spotShadowMap,R),y.state.pointShadowMap.length>0&&T.setValue(F,`pointShadowMap`,y.state.pointShadowMap,R)),i.isSkinnedMesh){T.setOptional(F,i,`bindMatrix`),T.setOptional(F,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(F,`boneTexture`,e.boneTexture,R))}i.isBatchedMesh&&(T.setOptional(F,i,`batchingTexture`),T.setValue(F,`batchingTexture`,i._matricesTexture,R),T.setOptional(F,i,`batchingIdTexture`),T.setValue(F,`batchingIdTexture`,i._indirectTexture,R),T.setOptional(F,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(F,`batchingColorTexture`,i._colorsTexture,R));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&$e.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(F,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Jl()),C){if(T.setValue(F,`toneMappingExposure`,N.toneMappingExposure),v.needsLights&&H(E,w),a&&r.fog===!0&&We.refreshFogUniforms(E,a),We.refreshMaterialUniforms(E,r,ye,ve,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Dc.upload(F,Tt(v),E,R)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Dc.upload(F,Tt(v),E,R),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(F,`center`,i.center),T.setValue(F,`modelViewMatrix`,i.modelViewMatrix),T.setValue(F,`normalMatrix`,i.normalMatrix),T.setValue(F,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];at.update(n,x),at.bind(n,x)}}return x}function H(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.sunLights.needsUpdate=t,e.sunLightShadows.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function kt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ce},this.getActiveMipmapLevel=function(){return le},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(e,t,n){let r=L.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),L.get(e.texture).__webglTexture=t,L.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=L.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){P=e,ce=t,le=n;let r=null,i=!1,a=!1;if(e){let o=L.get(e);if(o.__useDefaultFramebuffer!==void 0){I.bindFramebuffer(F.FRAMEBUFFER,o.__webglFramebuffer),fe.copy(e.viewport),pe.copy(e.scissor),me=e.scissorTest,I.viewport(fe),I.scissor(pe),I.setScissorTest(me),ue=-1;return}if(o.__webglFramebuffer===void 0)R.setupRenderTarget(e);else if(o.__hasExternalTextures)R.rebindTextures(e,L.get(e.texture).__webglTexture,L.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&L.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);R.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=L.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&R.useMultisampledRTT(e)===!1?L.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,fe.copy(e.viewport),pe.copy(e.scissor),me=e.scissorTest}else fe.copy(Se).multiplyScalar(ye).floor(),pe.copy(Ce).multiplyScalar(ye).floor(),me=we;if(n!==0&&(r=ae),I.bindFramebuffer(F.FRAMEBUFFER,r)&&I.drawBuffers(e,r),I.viewport(fe),I.scissor(pe),I.setScissorTest(me),i){let r=L.get(e.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=L.get(e.textures[t]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=L.get(e.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,t.__webglTexture,n)}ue=-1};function At(e){let t=L.get(e);return(t.__readFormat!==e.format||t.__readType!==e.type)&&(t.__readFormat=e.format,t.__readType=e.type,t.__formatReadable=Ie.textureFormatReadable(e.format),t.__typeReadable=Ie.textureTypeReadable(e.type)),t}this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){I.bindFramebuffer(F.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;e.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+s);let u=At(o);if(u.__formatReadable===!1){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(u.__typeReadable===!1){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&F.readPixels(t,n,r,i,rt.convert(c),rt.convert(l),a)}finally{let e=P===null?null:L.get(P).__webglFramebuffer;I.bindFramebuffer(F.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){I.bindFramebuffer(F.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;e.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+s);let d=At(o);if(d.__formatReadable===!1)throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(d.__typeReadable===!1)throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let f=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,f),F.bufferData(F.PIXEL_PACK_BUFFER,a.byteLength,F.STREAM_READ),F.readPixels(t,n,r,i,rt.convert(l),rt.convert(u),0),F.bindBuffer(F.PIXEL_PACK_BUFFER,null);let p=P===null?null:L.get(P).__webglFramebuffer;I.bindFramebuffer(F.FRAMEBUFFER,p);let m=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await et(F,m,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,f),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,a),F.bindBuffer(F.PIXEL_PACK_BUFFER,null),F.deleteBuffer(f),F.deleteSync(m),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;R.setTexture2D(e,0),F.copyTexSubImage2D(F.TEXTURE_2D,n,0,0,o,s,i,a),I.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=rt.convert(t.format),_=rt.convert(t.type),v;t.isData3DTexture?(R.setTexture3D(t,0),v=F.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(R.setTexture2DArray(t,0),v=F.TEXTURE_2D_ARRAY):(R.setTexture2D(t,0),v=F.TEXTURE_2D),I.activeTexture(F.TEXTURE0),I.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,t.flipY),I.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),I.pixelStorei(F.UNPACK_ALIGNMENT,t.unpackAlignment);let y=I.getParameter(F.UNPACK_ROW_LENGTH),b=I.getParameter(F.UNPACK_IMAGE_HEIGHT),x=I.getParameter(F.UNPACK_SKIP_PIXELS),S=I.getParameter(F.UNPACK_SKIP_ROWS),C=I.getParameter(F.UNPACK_SKIP_IMAGES);I.pixelStorei(F.UNPACK_ROW_LENGTH,h.width),I.pixelStorei(F.UNPACK_IMAGE_HEIGHT,h.height),I.pixelStorei(F.UNPACK_SKIP_PIXELS,l),I.pixelStorei(F.UNPACK_SKIP_ROWS,u),I.pixelStorei(F.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=L.get(e),r=L.get(t),h=L.get(n.__renderTarget),g=L.get(r.__renderTarget);I.bindFramebuffer(F.READ_FRAMEBUFFER,h.__webglFramebuffer),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,L.get(e).__webglTexture,i,d+n),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,L.get(t).__webglTexture,a,m+n)),F.blitFramebuffer(l,u,o,s,f,p,o,s,F.DEPTH_BUFFER_BIT,F.NEAREST);I.bindFramebuffer(F.READ_FRAMEBUFFER,null),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||L.has(e)){let n=L.get(e),r=L.get(t);I.bindFramebuffer(F.READ_FRAMEBUFFER,oe),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,se);for(let e=0;e<c;e++)w?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,n.__webglTexture,i),T?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,r.__webglTexture,a),i===0?T?F.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):F.copyTexSubImage2D(v,a,f,p,l,u,o,s):F.blitFramebuffer(l,u,o,s,f,p,o,s,F.COLOR_BUFFER_BIT,F.NEAREST);I.bindFramebuffer(F.READ_FRAMEBUFFER,null),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?F.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?F.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):F.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):F.texSubImage2D(F.TEXTURE_2D,a,f,p,o,s,g,_,h);I.pixelStorei(F.UNPACK_ROW_LENGTH,y),I.pixelStorei(F.UNPACK_IMAGE_HEIGHT,b),I.pixelStorei(F.UNPACK_SKIP_PIXELS,x),I.pixelStorei(F.UNPACK_SKIP_ROWS,S),I.pixelStorei(F.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&F.generateMipmap(v),I.unbindTexture()},this.initRenderTarget=function(e){L.get(e).__webglFramebuffer===void 0&&R.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?R.setTextureCube(e,0):e.isData3DTexture?R.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?R.setTexture2DArray(e,0):R.setTexture2D(e,0),I.unbindTexture()},this.resetState=function(){ce=0,le=0,P=null,I.reset(),it.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=It._getDrawingBufferColorSpace(e),t.unpackColorSpace=It._getUnpackColorSpace()}},Xl={type:`change`},Zl={type:`start`},Ql={type:`end`},$l=new ai,eu=new Ir,tu=Math.cos(70*Ot.DEG2RAD),nu=new U,ru=2*Math.PI,iu={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},au=1e-6,ou=class extends Ao{constructor(n,r=null){super(n,r),this.state=iu.NONE,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new U,this._lastQuaternion=new kt,this._lastTargetPosition=new U,this._quat=new kt().setFromUnitVectors(n.up,new U(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ko,this._sphericalDelta=new ko,this._scale=1,this._panOffset=new U,this._rotateStart=new H,this._rotateEnd=new H,this._rotateDelta=new H,this._panStart=new H,this._panEnd=new H,this._panDelta=new H,this._dollyStart=new H,this._dollyEnd=new H,this._dollyDelta=new H,this._dollyDirection=new U,this._mouse=new H,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=cu.bind(this),this._onPointerDown=su.bind(this),this._onPointerUp=lu.bind(this),this._onContextMenu=gu.bind(this),this._onMouseWheel=fu.bind(this),this._onKeyDown=pu.bind(this),this._onTouchStart=mu.bind(this),this._onTouchMove=hu.bind(this),this._onMouseDown=uu.bind(this),this._onMouseMove=du.bind(this),this._interceptControlDown=_u.bind(this),this._interceptControlUp=vu.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.state=iu.NONE,this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents();let e=this.domElement.getRootNode();e.removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),e.removeEventListener(`keyup`,this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction=``,this.domElement.style.cursor=`auto`}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Xl),this.update(),this.state=iu.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;nu.copy(t).sub(this.target),nu.applyQuaternion(this._quat),this._spherical.setFromVector3(nu),this.autoRotate&&this.state===iu.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=ru:n>Math.PI&&(n-=ru),r<-Math.PI?r+=ru:r>Math.PI&&(r-=ru),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(nu.setFromSpherical(this._spherical),nu.applyQuaternion(this._quatInverse),t.copy(this.target).add(nu),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=nu.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new U(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new U(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=nu.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):($l.origin.copy(this.object.position),$l.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot($l.direction))<tu?this.object.lookAt(this.target):(eu.setFromNormalAndCoplanarPoint(this.object.up,this.target),$l.intersectPlane(eu,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>au||8*(1-this._lastQuaternion.dot(this.object.quaternion))>au||this._lastTargetPosition.distanceToSquared(this.target)>au?(this.dispatchEvent(Xl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?ru/60/60*this.autoRotateSpeed:ru/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){nu.setFromMatrixColumn(t,0),nu.multiplyScalar(-e),this._panOffset.add(nu)}_panUp(e,t){this.screenSpacePanning===!0?nu.setFromMatrixColumn(t,1):(nu.setFromMatrixColumn(t,0),nu.crossVectors(this.object.up,nu)),nu.multiplyScalar(e),this._panOffset.add(nu)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;nu.copy(r).sub(this.target);let i=nu.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(ru*this._rotateDelta.x/t.clientHeight),this._rotateUp(ru*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(ru*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-ru*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(ru*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-ru*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(ru*this._rotateDelta.x/t.clientHeight),this._rotateUp(ru*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new H,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function su(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function cu(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function lu(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Ql),this.state=iu.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function uu(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=iu.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=iu.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=iu.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=iu.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=iu.PAN}break;default:this.state=iu.NONE}this.state!==iu.NONE&&this.dispatchEvent(Zl)}function du(e){switch(this.state){case iu.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case iu.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case iu.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function fu(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===iu.NONE&&(e.preventDefault(),this.dispatchEvent(Zl),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Ql))}function pu(e){this.enabled!==!1&&this._handleKeyDown(e)}function mu(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=iu.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=iu.TOUCH_PAN;break;default:this.state=iu.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=iu.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=iu.TOUCH_DOLLY_ROTATE;break;default:this.state=iu.NONE}break;default:this.state=iu.NONE}this.state!==iu.NONE&&this.dispatchEvent(Zl)}function hu(e){switch(this._trackPointer(e),this.state){case iu.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case iu.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case iu.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case iu.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=iu.NONE}}function gu(e){this.enabled!==!1&&e.preventDefault()}function _u(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function vu(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var yu={watch:{id:`watch`,chapter:`第一章`,title:`停住的时间`,objectName:`怀表`,letterDate:`9 月 15 日`,letter:[`这只怀表停了很多年。它属于一个总是迟到的人。过去我以为，只要它不再走动，那段等待也会跟着停下来。`,`现在我想知道，它还能不能重新开始。`],signature:`—— 林女士`,enterLabel:`查看怀表`,stepCopy:[[`打开怀表后盖`,`点击金色后盖，把它打开。`],[`取下固定环`,`把外侧固定环拖到右侧零件托盘。`],[`移出主齿轮`,`把中央主齿轮拖到零件托盘。`],[`清理内部积尘`,`选择左侧软刷，再点击怀表内部的积尘。`],[`调整松动发条`,`把橙色发条拖到内部发光插槽。`],[`装回主齿轮`,`把托盘中的齿轮拖回中央发光插槽。`],[`装回固定环`,`把托盘中的固定环拖回怀表外圈。`],[`转动旋钮测试`,`先合上后盖，再点击右侧调时旋钮。`]],closeCopy:[`合上怀表后盖`,`点击抬起的后盖，把它合上。`],completeInstruction:`怀表重新开始走动。`,endingTitle:`时间重新开始走了`,endingQuote:`表盖内侧刻着同一个日期。那不是分别的日子，而是他们第一次见面的日子。`,endingStory:[`第二天，林女士回来取表。她把怀表贴近耳边，听了很久，直到滴答声与墙上的挂钟慢慢重合。`,`她没有把表收进盒子，而是拨通了一个多年没有联系的号码：“下午三点，老车站。如果你还愿意等我，这一次我不会迟到。”`,`傍晚，修理铺收到一张照片：两杯还冒着热气的茶，怀表放在中间。照片背面只写了一句——这一次，我们都准时到了。`]},camera:{id:`camera`,chapter:`第二章`,title:`没有洗出的夏天`,objectName:`相机`,letterDate:`9 月 18 日`,letter:[`父亲留下的这台相机卡住了。里面还有一卷没有拍完的胶片，我一直不敢打开它。`,`如果快门还能响一次，也许我就有勇气把那个夏天洗出来。`],signature:`—— 周先生`,enterLabel:`查看相机`,stepCopy:[[`打开相机后盖`,`点击深色后盖，检查胶片仓。`],[`松开胶卷轴螺丝`,`选择左侧螺丝刀，再点击两枚银色固定螺丝。`],[`取下胶片压板`,`把中央金属压板拖到右侧零件托盘。`],[`取出胶卷轴`,`把左侧胶卷轴拖到零件托盘。`],[`清理快门积尘`,`选择左侧软刷，再点击快门帘上的积尘。`],[`校正快门帘`,`把错位的黑色快门帘拖回发光导轨。`],[`擦拭取景镜片`,`选择左侧擦拭布，再点击蓝色镜片。`],[`装回胶卷轴`,`把托盘中的胶卷轴拖回左侧轴仓。`],[`装回胶片压板`,`把托盘中的金属压板拖回中央卡槽。`],[`锁紧胶卷轴`,`再次选择螺丝刀，点击银色固定螺丝。`],[`按下快门测试`,`先合上相机后盖，再点击顶部快门钮。`]],closeCopy:[`合上相机后盖`,`点击抬起的后盖，把它合上。`],completeInstruction:`快门清脆地响了一声。`,endingTitle:`那个夏天还在胶片里`,endingQuote:`计数窗停在第十九张。最后一张照片，还等着今天的光。`,endingStory:[`周先生接过相机，没有立刻离开。他走到门口，对着午后的修理铺按下快门，让第二十张照片记住重新启动的声音。`,`一周后，他带来洗好的胶卷。前十九张是父亲拍下的海边、旧自行车和一家人的背影；最后一张里，阳光正落在修理铺的窗沿。`,`他把最后一张留给了这里，并在相纸背面写道——我原以为胶片里只剩过去，原来它也能装下继续生活的那一天。`]},"music-box":{id:`music-box`,chapter:`第三章`,title:`迟到的摇篮曲`,objectName:`音乐盒`,letterDate:`9 月 22 日`,letter:[`这是母亲小时候哄我入睡的音乐盒。搬家那天它从箱子里摔了出来，从此只剩下发条空转的声音。`,`下个月我也要成为母亲了。我想再听一次那首没有唱完的曲子。`],signature:`—— 许小姐`,enterLabel:`查看音乐盒`,stepCopy:[[`打开音乐盒盖`,`点击木质上盖，查看音筒和簧片。`],[`拔出音筒定位销`,`选择左侧镊子，再点击音筒右端的红色定位销。`],[`取出黄铜音筒`,`把带凸点的黄铜音筒拖到右侧零件托盘。`],[`松开音梳螺丝`,`选择螺丝刀，点击音梳两侧的固定螺丝。`],[`清理音梳碎屑`,`选择左侧软刷，再点击银色音梳上的碎屑。`],[`校直弯曲簧片`,`把翘起的橙色簧片拖回发光槽位。`],[`润滑调速器`,`选择擦拭布，再点击右侧小型调速器。`],[`锁紧音梳螺丝`,`选择螺丝刀，重新锁紧音梳。`],[`装回黄铜音筒`,`把托盘中的音筒拖回木盒轴座。`],[`插回音筒定位销`,`再次选择镊子，点击红色定位销。`],[`转动钥匙测试`,`先合上木盖，再点击右侧上弦钥匙。`]],closeCopy:[`合上音乐盒盖`,`点击抬起的木盖，把它合上。`],completeInstruction:`滚筒转动，旋律重新响起。`,endingTitle:`摇篮曲有了新的听众`,endingQuote:`盒底写着一行褪色的小字：愿你每一次醒来，都知道有人在等你。`,endingStory:[`许小姐把音乐盒轻轻贴近腹部。熟悉的旋律刚走到第二节，孩子便轻轻踢了一下，像是在回应一首隔了两代人的歌。`,`她说母亲总在最后一句前睡着，所以那段旋律从来没有真正唱完。临走时，她第一次把缺失的尾声哼了出来。`,`两个月后，一张出生卡寄到修理铺。照片里的音乐盒守在摇篮旁，卡片上写着——外婆没有唱完的部分，现在轮到我继续唱了。`]}};function bu(e){return e===`watch`||e===`camera`||e===`music-box`}var xu={watch:[`open-cover`,`remove-ring`,`remove-gear`,`clean-dust`,`fix-spring`,`restore-gear`,`restore-ring`],camera:[`open-cover`,`loosen-screws`,`remove-pressure`,`remove-spool`,`clean-dust`,`align-curtain`,`clean-lens`,`restore-spool`,`restore-pressure`,`tighten-screws`],"music-box":[`open-cover`,`release-pin`,`remove-cylinder`,`loosen-comb`,`clean-dust`,`align-tine`,`oil-governor`,`tighten-comb`,`restore-cylinder`,`secure-pin`]};function Su(e,t=8){let n=Math.max(0,Math.min(Number.isFinite(e.step)?Math.floor(e.step??0):0,t));return{step:n,coverClosed:n>=t||n===t-1&&!!e.coverClosed}}function Cu(e,t,n=`watch`){let r=xu[n].length,i=r+1,a=Su(e,i);return a.step>=i?{state:a,accepted:!1,completed:!0}:a.step<r&&xu[n][a.step]===t?{state:Su({step:a.step+1,coverClosed:!1},i),accepted:!0,completed:!1}:a.step===r&&!a.coverClosed&&t===`close-cover`?{state:{step:r,coverClosed:!0},accepted:!0,completed:!1}:a.step===r&&a.coverClosed&&t===`test-crown`?{state:{step:i,coverClosed:!0},accepted:!0,completed:!0}:{state:a,accepted:!1,completed:!1}}var wu={volume:65,reduceMotion:!1,autoHint:!0};function Tu(){return{version:2,hasStarted:!1,completed:!1,step:0,coverClosed:!1,levelId:`watch`,settings:{...wu}}}function Eu(e){if(!e)return null;try{let t=JSON.parse(e);if(t.version!==1&&t.version!==2)return null;let n=bu(t.levelId)?t.levelId:`watch`,r=Su(t,yu[n].stepCopy.length);return{version:2,hasStarted:!!t.hasStarted,completed:!!t.completed||r.step>=yu[n].stepCopy.length,...r,levelId:n,settings:{volume:Math.max(0,Math.min(100,Number(t.settings?.volume??wu.volume))),reduceMotion:!!t.settings?.reduceMotion,autoHint:t.settings?.autoHint??wu.autoHint}}}catch{return null}}function Du(e,t){return{load:()=>Eu(e.getItem(t)),write:n=>e.setItem(t,JSON.stringify(n)),clear:()=>e.removeItem(t)}}var Ou=Du(localStorage,`old-object-letter-3d-prototype-v1`),Z={screen:`loading`,levelId:`watch`,step:0,coverClosed:!1,selectedTool:null,hintLevel:0,lastActivity:Date.now(),settings:{...wu}};function ku(){return yu[Z.levelId].stepCopy.length}function Au(){return ku()-1}function ju(e){let t=document.querySelector(e);if(!t)throw Error(`Missing required element: ${e}`);return t}var Q={screens:[...document.querySelectorAll(`.screen`)],canvas:ju(`#scene`),continueButton:ju(`#continue-button`),stepCount:ju(`#step-count`),stepTitle:ju(`#step-title`),instruction:ju(`#instruction`),brush:ju(`#brush-tool`),screwdriver:ju(`[data-tool="screwdriver"]`),tweezers:ju(`[data-tool="tweezers"]`),cloth:ju(`[data-tool="cloth"]`),inspect:ju(`[data-tool="inspect"]`),settingsModal:ju(`#settings-modal`),pauseModal:ju(`#pause-modal`),confirmModal:ju(`#confirm-modal`),toast:ju(`#toast`),volume:ju(`#volume`),reduceMotion:ju(`#reduce-motion`),autoHint:ju(`#auto-hint`),debugState:ju(`#debug-state`),chapterTitle:ju(`#chapter-title`),letterDate:ju(`#letter-date`),letterTitle:ju(`#letter-title`),letterBody:ju(`#letter-body`),letterSignature:ju(`#letter-signature`),enterWorkshop:ju(`#enter-workshop`),endingTitle:ju(`#ending-title`),endingQuote:ju(`#ending-quote`),endingBody:ju(`#ending-body`)};function Mu(e,t){let n=`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><circle cx="12" cy="12" r="7" fill="${t}" stroke="${e}" stroke-width="2"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4" stroke="${e}" stroke-width="1.5" stroke-linecap="round"/><circle cx="12" cy="12" r="1.8" fill="${e}"/></svg>`;return`url("data:image/svg+xml,${encodeURIComponent(n)}") 12 12, crosshair`}var Nu={idle:Mu(`#53615b`,`rgba(255,249,237,.82)`),valid:Mu(`#d2aa5f`,`rgba(255,249,237,.96)`)},Pu=!1;function Fu(e=!1){Pu=e,Z.selectedTool?(Q.canvas.dataset.activeTool=Z.selectedTool,Q.canvas.dataset.toolTarget=e?`valid`:`idle`,Q.canvas.style.cursor=e?Nu.valid:Nu.idle):(delete Q.canvas.dataset.activeTool,delete Q.canvas.dataset.toolTarget,Q.canvas.style.removeProperty(`cursor`))}function Iu(){Q.brush.classList.toggle(`active`,Z.selectedTool===`brush`),Q.screwdriver.classList.toggle(`active`,Z.selectedTool===`screwdriver`),Q.tweezers.classList.toggle(`active`,Z.selectedTool===`tweezers`),Q.cloth.classList.toggle(`active`,Z.selectedTool===`cloth`),Fu(!1)}function Lu(){return Ou.load()}function Ru(){let e={version:2,hasStarted:!0,completed:Z.step>=ku()||Z.screen===`ending`,step:Z.step,coverClosed:Z.coverClosed,levelId:Z.levelId,settings:Z.settings};Ou.write(e),Bu()}function zu(){let e=Lu()??Tu();e.settings=Z.settings,Ou.write(e),Bu()}function Bu(){let e=Lu();Q.continueButton.disabled=!e?.hasStarted,Q.continueButton.textContent=e?.completed?`查看「${yu[e.levelId].title}」结果`:e?`继续「${yu[e.levelId].title}」`:`继续上次进度`}function Vu(e){Z.screen=e,Q.screens.forEach(t=>t.classList.toggle(`active`,t.id===e)),Qu.enabled=!!(e===`workshop`&&Q.pauseModal.hidden&&Q.settingsModal.hidden),Ku()}var Hu=0;function Uu(e){Q.toast.textContent=e,Q.toast.classList.add(`show`),window.clearTimeout(Hu),Hu=window.setTimeout(()=>Q.toast.classList.remove(`show`),1900)}var Wu=null;function Gu(e=`ok`){if(!(Z.settings.volume<=0))try{Wu??=new AudioContext;let t=Wu.createOscillator(),n=Wu.createGain();t.type=e===`finish`?`sine`:`triangle`,t.frequency.value=e===`wrong`?150:e===`finish`?640:430,n.gain.value=Z.settings.volume/100*.045,t.connect(n).connect(Wu.destination),t.start(),n.gain.exponentialRampToValueAtTime(1e-4,Wu.currentTime+(e===`finish`?.6:.18)),t.stop(Wu.currentTime+(e===`finish`?.61:.19))}catch{}}function Ku(){Q.debugState.textContent=`level: ${Z.levelId} · screen: ${Z.screen} · step: ${Z.step} · cover: ${Z.coverClosed?`closed`:`open`}`}var qu=new Yl({canvas:Q.canvas,antialias:!0,powerPreference:`high-performance`});qu.setPixelRatio(Math.min(window.devicePixelRatio,2)),qu.shadowMap.enabled=!0,qu.shadowMap.type=2,qu.outputColorSpace=ze,qu.toneMapping=4,qu.toneMappingExposure=1.05;var Ju=new Fn;Ju.background=new K(12949350),Ju.fog=new Pn(12949350,16,30);var Yu=new ro(36,1,.1,100),Xu=new U(0,8.6,10.8),Zu=new U(.5,.25,0);Yu.position.copy(Xu);var Qu=new ou(Yu,Q.canvas);Qu.target.copy(Zu),Qu.enableDamping=!0,Qu.dampingFactor=.075,Qu.enablePan=!1,Qu.minDistance=8,Qu.maxDistance=16,Qu.minPolarAngle=.34,Qu.maxPolarAngle=1.28,Qu.minAzimuthAngle=-.95,Qu.maxAzimuthAngle=.95,Qu.update(),Ju.add(new Ga(16773842,6440238,2.4));var $u=new oo(16769194,4.2);$u.position.set(-4,9,6),$u.castShadow=!0,$u.shadow.mapSize.set(1024,1024),$u.shadow.camera.left=-9,$u.shadow.camera.right=9,$u.shadow.camera.top=9,$u.shadow.camera.bottom=-9,Ju.add($u);var ed=new oo(12115407,2.2);ed.position.set(7,5,-6),Ju.add(ed);var td=new xa({color:11106381,roughness:.88,metalness:0}),nd=new q(new oa(32,24),td);nd.rotation.x=-Math.PI/2,nd.position.y=-.03,nd.receiveShadow=!0,Ju.add(nd);for(let e=-14;e<=14;e+=2.4){let t=new q(new oa(.018,24),new oi({color:7294002,transparent:!0,opacity:.18}));t.rotation.x=-Math.PI/2,t.position.set(e,.002,0),Ju.add(t)}var rd=new G;rd.position.set(4.35,.08,.15);var id=new q(new J(2.35,.14,5.05),new xa({color:9201737,roughness:.82}));id.receiveShadow=!0,rd.add(id);var ad=new q(new J(2.08,.08,4.76),new xa({color:14201471,roughness:.92}));ad.position.y=.09,ad.receiveShadow=!0,rd.add(ad),Ju.add(rd);var od=new xa({color:10449711,metalness:.82,roughness:.3}),sd=new xa({color:14068305,metalness:.78,roughness:.23}),cd=new xa({color:15780466,metalness:.88,roughness:.17}),ld=new xa({color:7491880,metalness:.7,roughness:.46}),ud=new xa({color:3157547,metalness:.68,roughness:.33}),dd=new xa({color:10197649,metalness:.86,roughness:.24}),fd=new xa({color:12082997,metalness:.7,roughness:.28}),pd=new xa({color:9313586,metalness:.08,roughness:.2}),md=new xa({color:15655101,metalness:.03,roughness:.52}),hd=new xa({color:13093316,metalness:.88,roughness:.2,depthTest:!1,depthWrite:!1}),gd=new xa({color:3166022,metalness:.16,roughness:.48,depthTest:!1,depthWrite:!1}),_d=new xa({color:10115128,metalness:.04,roughness:.6,depthTest:!1,depthWrite:!1}),vd=new xa({color:13806175,metalness:.68,roughness:.28,depthTest:!1,depthWrite:!1}),yd=new xa({color:15193770,metalness:0,roughness:.94,depthTest:!1,depthWrite:!1,side:2});function bd(e){return e.traverse(e=>{e.renderOrder=100,e instanceof q&&(e.castShadow=!1,e.receiveShadow=!1)}),e}function xd(){let e=new G,t=new q(new Mi(.085,.22,10),hd);t.position.y=.11,e.add(t);let n=new q(new ji(.055,.055,1.08,12),hd);n.position.y=.72,e.add(n);let r=new q(new ji(.23,.18,.86,18),gd);r.position.y=1.68,e.add(r);for(let t=0;t<4;t+=1){let n=new q(new la(.225-t*.01,.025,6,18),vd);n.rotation.x=Math.PI/2,n.position.y=1.39+t*.19,e.add(n)}return e.rotation.z=-.55,bd(e)}function Sd(){let e=new G,t=[];for(let n of[-1,1]){let r=new q(new J(.075,1.75,.065),hd);r.position.set(n*.12,.88,0),r.rotation.z=n*-.105,e.add(r),t.push(r)}let n=new q(new J(.38,.18,.11),vd);return n.position.y=1.72,e.add(n),e.userData.arms=t,e.rotation.z=-.35,bd(e)}function Cd(){let e=new G;for(let t=-2;t<=2;t+=1){let n=new q(new Mi(.055,.48,8),vd);n.position.set(t*.08,.23,0),e.add(n)}let t=new q(new J(.55,.32,.18),hd);t.position.y=.63,e.add(t);let n=new q(new Ai(.16,1.05,6,12),_d);return n.position.y=1.42,e.add(n),e.rotation.z=-.48,bd(e)}function wd(){let e=new G,t=new q(new oa(1.05,.82,4,4),yd),n=t.geometry.attributes.position;for(let e=0;e<n.count;e+=1){let t=n.getX(e),r=n.getY(e);n.setZ(e,Math.sin(t*6+r*5)*.055)}return n.needsUpdate=!0,t.geometry.computeVertexNormals(),t.position.set(.48,.43,0),t.rotation.z=-.22,e.add(t),bd(e)}var Td=new G,Ed=new G,Dd={screwdriver:xd(),tweezers:Sd(),brush:Cd(),cloth:wd()};Object.values(Dd).forEach(e=>Ed.add(e)),Td.add(Ed),Td.scale.setScalar(.22),Td.visible=!1,Ju.add(Td);var Od=new U,kd=!1,Ad=null;function jd(){return Z.selectedTool??Ad?.tool??null}function Md(e){Ad={tool:e,startedAt:performance.now()}}function Nd(){let e=Ad?performance.now()-Ad.startedAt:1/0;Ad&&e>(Z.settings.reduceMotion?80:460)&&(Ad=null);let t=jd();if(Td.visible=!!(t&&kd&&Z.screen===`workshop`&&Q.pauseModal.hidden&&Q.settingsModal.hidden),Object.entries(Dd).forEach(([e,n])=>{n.visible=e===t}),!Td.visible||!t)return;Td.position.lerp(Od,Z.settings.reduceMotion?1:.34),Td.quaternion.copy(Yu.quaternion),Ed.rotation.set(0,0,0),Ed.scale.setScalar(Pu?1.06:1);let n=Ad?Math.min(1,e/460):0,r=Math.sin(n*Math.PI*4)*(1-n);Ad?.tool===`screwdriver`&&(Ed.rotation.y=r*.85),Ad?.tool===`brush`&&(Ed.rotation.z=r*.22),Ad?.tool===`cloth`?(Ed.position.x=Math.cos(n*Math.PI*4)*.12,Ed.position.y=Math.sin(n*Math.PI*4)*.09):Ed.position.set(0,0,0),Dd.tweezers.userData.arms.forEach((e,t)=>{let n=t===0?-1:1;e.rotation.z=n*(-.105+(Ad?.tool===`tweezers`?Math.abs(r)*.075:0))})}var $=new G;$.position.set(-.65,0,0),Ju.add($);function Pd(e){e.traverse(e=>{e instanceof q&&(e.castShadow=!0,e.receiveShadow=!0)})}function Fd(e,t){e.userData.partName=t,e.traverse(t=>{t.userData.interactiveRoot=e})}var Id=new q(new ji(2.22,2.18,.5,96),od);Id.position.y=.28,Fd(Id,`body`),$.add(Id);var Ld=new q(new la(2.12,.105,12,96),ld);Ld.rotation.x=Math.PI/2,Ld.position.y=.08,$.add(Ld);var Rd=new q(new la(2.13,.09,12,96),cd);Rd.rotation.x=Math.PI/2,Rd.position.y=.54,$.add(Rd);var zd=[];for(let e=0;e<48;e+=1){let t=new q(new J(.035,.22,.09),ld),n=e/48*Math.PI*2;t.position.set(Math.cos(n)*2.205,.27,Math.sin(n)*2.205),t.rotation.y=-n,$.add(t),zd.push(t)}var Bd=new q(new ji(1.92,1.98,.18,64),ud);Bd.position.y=.61,$.add(Bd);var Vd=new q(new ji(1.72,1.72,.025,64),new xa({color:7167042,metalness:.2,roughness:.66}));Vd.position.y=.72,$.add(Vd);function Hd(e,t,n,r,i,a=sd){let o=new G;o.position.set(t,.2,n);let s=new q(new la(r*.72,r*.1,7,36),a);s.rotation.x=Math.PI/2,o.add(s);let c=new q(new ji(r*.17,r*.17,.12,18),pd);o.add(c);for(let e=0;e<6;e+=1){let t=new q(new J(r*.11,.07,r*1.2),a);t.rotation.y=e/6*Math.PI,o.add(t)}for(let e=0;e<i;e+=1){let t=new q(new J(r*.14,.09,r*.18),a),n=e/i*Math.PI*2;t.position.set(Math.cos(n)*r*.86,0,Math.sin(n)*r*.86),t.rotation.y=-n,o.add(t)}return e.add(o),o}Hd(Bd,-.9,.58,.48,18,dd),Hd(Bd,.9,.48,.38,16,sd),Hd(Bd,-.82,-.68,.3,14,fd);var Ud=new q(new J(1.15,.11,.28),od);Ud.position.set(.56,.19,-.9),Ud.rotation.y=-.28,Bd.add(Ud),[[-1.38,.9],[1.28,.78],[-1.32,-.95],[1.18,-.96]].forEach(([e,t])=>{let n=new q(new ji(.105,.105,.1,20),dd);n.position.set(e,.18,t);let r=new q(new J(.13,.025,.018),ud);r.position.y=.06,n.add(r),Bd.add(n)});var Wd=new G;Wd.position.set(-2.12,.63,0),$.add(Wd);var Gd=new q(new ji(2.14,2.14,.2,96),sd);Gd.position.x=2.12,Gd.position.y=.06,Wd.add(Gd),Fd(Wd,`cover`);var Kd=new q(new la(1.89,.06,10,64),ud);Kd.rotation.x=Math.PI/2,Kd.position.set(2.12,.175,0),Wd.add(Kd);var qd=new q(new la(2.02,.075,10,96),cd);qd.rotation.x=Math.PI/2,qd.position.set(2.12,.175,0),Wd.add(qd);var Jd=new q(new la(1.25,.018,6,64),new xa({color:8413999,metalness:.65,roughness:.3}));Jd.rotation.x=Math.PI/2,Jd.position.set(2.12,.18,0),Wd.add(Jd);var Yd=new q(new ji(.56,.56,.025,64),ld);Yd.position.set(2.12,.195,0),Wd.add(Yd);for(let e=0;e<24;e+=1){let t=new q(new J(e%2==0?.035:.02,.018,.48),ld),n=e/24*Math.PI*2;t.position.set(2.12+Math.sin(n)*.9,.2,Math.cos(n)*.9),t.rotation.y=n,Wd.add(t)}var Xd=new q(new ji(.16,.16,.58,20),ld);Xd.rotation.z=Math.PI/2,Xd.position.set(.02,.62,0),$.add(Xd);var Zd=new q(new la(1.65,.105,12,64),sd);Zd.rotation.x=Math.PI/2,Zd.position.set(0,.9,0),Fd(Zd,`ring`),$.add(Zd);function Qd(){let e=new G,t=new q(new la(.64,.12,9,48),sd);t.rotation.x=Math.PI/2,e.add(t);let n=new q(new ji(.18,.18,.25,24),pd);n.position.y=.05,e.add(n);for(let t=0;t<6;t+=1){let n=new q(new J(.105,.13,1.18),sd);n.rotation.y=t/6*Math.PI,e.add(n)}for(let t=0;t<16;t+=1){let n=new q(new J(.22,.18,.25),sd),r=t/16*Math.PI*2;n.position.set(Math.cos(r)*.88,0,Math.sin(r)*.88),n.rotation.y=-r,e.add(n)}return e}var $d=Qd();$d.position.set(0,1.02,0),Fd($d,`gear`),$.add($d);var ef=new G,tf=[];for(let e=0;e<=90;e+=1){let t=e/90,n=t*Math.PI*5.5,r=.1+t*.52;tf.push(new U(Math.cos(n)*r,0,Math.sin(n)*r))}var nf=new q(new ua(new Hi(tf),120,.055,8,!1),fd);ef.add(nf);var rf=new q(new ji(.11,.11,.13,18),dd);ef.add(rf),ef.scale.set(1.35,1,.72),ef.position.set(.95,1.05,-.76),Fd(ef,`spring`),$.add(ef);var af=new G,of=new xa({color:12428405,roughness:1,transparent:!0,opacity:.88});[[-.75,-.45,.18],[-.58,-.65,.11],[.46,.62,.15],[.78,.35,.1],[-.95,.35,.08],[.25,-.85,.13]].forEach(([e,t,n])=>{let r=new q(new ca(n,14,8),of);r.scale.y=.16,r.position.set(e,0,t),af.add(r)}),af.position.y=1.12,Fd(af,`dust`),$.add(af);var sf=new q(new ji(.27,.27,.58,24),sd);sf.rotation.z=Math.PI/2,sf.position.set(2.42,.46,0),Fd(sf,`crown`),$.add(sf);var cf=[];for(let e=0;e<7;e+=1){let t=new q(new la(.275,.018,7,24),ld);t.rotation.y=Math.PI/2,t.position.set(2.16+e*.085,.46,0),t.userData.interactiveRoot=sf,$.add(t),cf.push(t)}var lf=new q(new la(.36,.08,10,42),od);lf.rotation.x=Math.PI/2,lf.scale.x=1.18,lf.position.set(2.96,.46,0),$.add(lf);var uf=new q(new J(.42,.18,.52),ld);uf.position.set(2.66,.45,0),$.add(uf);var df=new G,ff=new q(new ji(1.92,1.92,.16,64),md);df.add(ff);var pf=new q(new la(1.88,.075,10,96),cd);pf.rotation.x=Math.PI/2,pf.position.y=.1,df.add(pf);for(let e=0;e<60;e+=1){let t=e%5==0,n=new q(new J(t?.055:.025,.026,t?.25:.13),ud),r=e/60*Math.PI*2;n.position.set(Math.sin(r)*(t?1.55:1.63),.115,Math.cos(r)*(t?1.55:1.63)),n.rotation.y=r,df.add(n)}[`XII`,`I`,`II`,`III`,`IV`,`V`,`VI`,`VII`,`VIII`,`IX`,`X`,`XI`].forEach((e,t)=>{let n=document.createElement(`canvas`);n.width=128,n.height=64;let r=n.getContext(`2d`);if(!r)return;r.clearRect(0,0,n.width,n.height),r.fillStyle=`#352d25`,r.font=`600 34px Georgia, serif`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(e,64,32);let i=new Ei(n);i.colorSpace=ze;let a=new $r(new zr({map:i,transparent:!0,depthWrite:!1})),o=t/12*Math.PI*2;a.position.set(Math.sin(o)*1.25,.145,-Math.cos(o)*1.25),a.scale.set(.42,.21,1),a.rotation.x=-Math.PI/2,df.add(a)});var mf=new q(new J(.09,.05,1),ud);mf.geometry.translate(0,0,-.42),mf.position.y=.16,df.add(mf);var hf=new q(new J(.055,.05,1.42),ud);hf.geometry.translate(0,0,-.61),hf.position.y=.19,df.add(hf);var gf=new q(new J(.025,.035,1.5),fd);gf.geometry.translate(0,0,-.62),gf.position.y=.22,gf.rotation.y=.7,df.add(gf);var _f=new q(new ji(.09,.09,.09,20),sd);_f.position.y=.25,df.add(_f);var vf=new q(new ca(1.88,64,24,0,Math.PI*2,0,Math.PI*.18),new Sa({color:15332845,transmission:.72,transparent:!0,opacity:.22,roughness:.08,metalness:0,thickness:.12,depthWrite:!1}));vf.scale.y=.32,vf.position.y=.18,df.add(vf),df.position.y=.68,df.visible=!1,$.add(df),Wd.children.forEach(e=>{e.userData.levelVisual=`watch`});var yf=new G,bf=new xa({color:2503983,metalness:.08,roughness:.82}),xf=new q(new J(5.05,.48,3.72,4,1,4),bf);xf.position.y=.29,yf.add(xf),[-1.85,1.85].forEach(e=>{let t=new q(new J(.25,.58,3.78),ud);t.position.set(e,.32,0),yf.add(t)});var Sf=new q(new J(.82,.45,.62),ud);Sf.position.set(-1.12,.72,-1.2),yf.add(Sf),yf.visible=!1,$.add(yf);var Cf=new G,wf=new q(new J(4.3,.1,2.75),new xa({color:1514265,metalness:.5,roughness:.52}));wf.position.y=.68,Cf.add(wf),[-1.72,1.72].forEach(e=>{let t=new q(new ji(.56,.56,.16,32),ud);t.position.set(e,.79,0),Cf.add(t)}),yf.add(Cf);var Tf=new G;[[1.62,-1.08],[1.62,1.08]].forEach(([e,t])=>{let n=new q(new ji(.13,.13,.13,20),dd);n.position.set(e,0,t);let r=new q(new J(.15,.02,.025),ud);r.position.y=.075,n.add(r),Tf.add(n)}),Tf.position.y=.86,Fd(Tf,`camera-screws`),$.add(Tf);var Ef=new G,Df=new q(new ji(.36,.36,1.45,30),ud);Df.rotation.x=Math.PI/2,Ef.add(Df),[-.72,.72].forEach(e=>{let t=new q(new ji(.52,.52,.09,30),dd);t.rotation.x=Math.PI/2,t.position.z=e,Ef.add(t)}),Ef.position.set(-1.72,.92,0),Fd(Ef,`camera-spool`),$.add(Ef);var Of=new G;[[0,0,-.82,1.75,.08,.12],[0,0,.82,1.75,.08,.12],[-.82,0,0,.12,.08,1.75],[.82,0,0,.12,.08,1.75]].forEach(([e,t,n,r,i,a])=>{let o=new q(new J(r,i,a),dd);o.position.set(e,t,n),Of.add(o)});var kf=new q(new J(1.65,.07,1.65),new oi({transparent:!0,opacity:0,depthWrite:!1}));kf.position.y=.015,Of.add(kf),Of.position.set(.35,.98,0),Fd(Of,`camera-pressure`),$.add(Of);var Af=new q(new ji(.42,.42,.08,40),new Sa({color:4158849,metalness:.06,roughness:.16,transmission:.28}));Af.position.set(.35,.96,-1.28),Fd(Af,`camera-lens`),$.add(Af);var jf=new G,Mf=new q(new J(1.72,.08,1.8),new xa({color:2367517,roughness:.92}));jf.add(Mf);for(let e=-3;e<=3;e+=1){let t=new q(new J(.045,.025,1.72),new xa({color:e%2?1381394:3814189,roughness:.9}));t.position.set(e*.22,.055,0),jf.add(t)}jf.position.set(.35,.9,.36),Fd(jf,`camera-curtain`),$.add(jf);var Nf=new G;[[-.42,-.28],[.18,.4],[.54,-.38],[-.1,.72]].forEach(([e,t])=>{let n=new q(new ca(.11,10,6),of);n.scale.y=.14,n.position.set(e,0,t),Nf.add(n)}),Nf.position.set(.35,1.02,.36),Fd(Nf,`camera-dust`),$.add(Nf);var Pf=new G;Pf.userData.levelVisual=`camera`;var Ff=new q(new J(4.72,.18,3.42),bf);Ff.position.set(2.12,.08,0),Pf.add(Ff);var If=new q(new J(3.7,.035,2.5),ud);If.position.set(2.12,.19,0),Pf.add(If),Wd.add(Pf);var Lf=new G,Rf=new q(new ji(1.3,1.45,.62,64),ud);Rf.position.y=.75,Lf.add(Rf);var zf=new q(new la(1.12,.11,12,72),dd);zf.rotation.x=Math.PI/2,zf.position.y=1.08,Lf.add(zf);var Bf=new q(new ji(1.04,1.04,.04,64),new Sa({color:2641493,metalness:.05,roughness:.12,transmission:.32}));Bf.position.y=1.1,Lf.add(Bf),Lf.visible=!1,$.add(Lf);var Vf=new G,Hf=new xa({color:7290147,metalness:.02,roughness:.68}),Uf=new q(new J(5.1,.56,3.85,4,1,4),Hf);Uf.position.y=.3,Vf.add(Uf);var Wf=new q(new J(4.7,.08,3.45),new xa({color:10906171,roughness:.62}));Wf.position.y=.62,Vf.add(Wf),Vf.visible=!1,$.add(Vf);var Gf=new G,Kf=new q(new J(4.55,.08,3.18),new xa({color:4020813,roughness:.95}));Kf.position.y=.72,Gf.add(Kf),Vf.add(Gf);var qf=new G,Jf=new q(new ji(.54,.54,2.45,32),sd);Jf.rotation.z=Math.PI/2,qf.add(Jf);for(let e=-5;e<=5;e+=1)for(let t=0;t<8;t+=1){if((e+t)%3==0)continue;let n=new q(new ji(.025,.025,.11,7),dd),r=t/8*Math.PI*2;n.position.set(e*.2,Math.cos(r)*.56,Math.sin(r)*.56),qf.add(n)}qf.position.set(-.35,1.18,-.4),Fd(qf,`music-cylinder`),$.add(qf);var Yf=new G,Xf=new q(new ji(.075,.075,.48,16),dd);Xf.rotation.z=Math.PI/2,Yf.add(Xf);var Zf=new q(new ca(.14,16,10),pd);Zf.position.x=.28,Yf.add(Zf),Yf.position.set(1.18,1.18,-.4),Fd(Yf,`music-pin`),$.add(Yf);var Qf=new G;for(let e=0;e<15;e+=1){let t=new q(new J(.075,.055,.72+e*.028),dd);t.position.set(-.62+e*.09,0,0),Qf.add(t)}Qf.position.set(.25,.95,.82),$.add(Qf);var $f=new G;[[-.72,0],[.72,0]].forEach(([e,t])=>{let n=new q(new ji(.11,.11,.11,18),dd);n.position.set(e,0,t);let r=new q(new J(.13,.02,.02),ud);r.position.y=.065,n.add(r),$f.add(n)}),$f.position.set(.25,1.03,.82),Fd($f,`music-comb-screws`),$.add($f);var ep=new G,tp=new q(new ji(.09,.09,.28,16),dd);ep.add(tp);var np=new q(new J(.8,.07,.08),sd);np.position.y=.12,ep.add(np),[-.42,.42].forEach(e=>{let t=new q(new ca(.14,16,10),ld);t.position.set(e,.12,0),ep.add(t)}),ep.position.set(1.45,1.02,1.12),Fd(ep,`music-governor`),$.add(ep);var rp=new q(new J(.09,.08,1.15),fd);rp.position.set(.25,1.03,1.08),rp.rotation.y=-.38,Fd(rp,`music-tine`),$.add(rp);var ip=new G;[[-.35,0],[.1,.08],[.42,-.06]].forEach(([e,t])=>{let n=new q(new J(.1,.035,.04),fd);n.position.set(e,0,t),n.rotation.y=e*2,ip.add(n)}),ip.position.set(.25,1.08,.82),Fd(ip,`music-dust`),$.add(ip);var ap=new G;ap.userData.levelVisual=`music-box`;var op=new q(new J(4.76,.2,3.5),Hf);op.position.set(2.12,.08,0),ap.add(op);var sp=new q(new la(1.05,.035,8,64),sd);sp.rotation.x=Math.PI/2,sp.position.set(2.12,.2,0),ap.add(sp),Wd.add(ap);var cp=new G,lp=new q(new ji(.55,.55,2.1,28),sd);lp.rotation.z=Math.PI/2,lp.position.set(0,1,-.28),cp.add(lp);for(let e=0;e<14;e+=1){let t=new q(new J(.09,.05,.55+e*.025),dd);t.position.set(-.62+e*.095,1.04,.72),cp.add(t)}cp.visible=!1,$.add(cp);function up(e,t,n){let r=new q(e,t);return r.position.copy(n),r.userData.interactiveRoot=sf,r.visible=!1,$.add(r),r}var dp=up(new ji(.24,.24,.3,24),dd,new U(1.35,.96,-1.72)),fp=up(new la(.32,.07,9,30),sd,new U(2.75,.9,0));fp.rotation.x=Math.PI/2;var pp=[Ld,Rd,Xd,sf,lf,uf,...zd,...cf],mp={watch:sf,camera:dp,"music-box":fp};function hp(){let e=Z.levelId;Id.visible=e===`watch`,pp.forEach(t=>{t.visible=e===`watch`}),yf.visible=e===`camera`,Vf.visible=e===`music-box`,dp.visible=e===`camera`,fp.visible=e===`music-box`,Wd.children.forEach(t=>{let n=t.userData.levelVisual;n&&(t.visible=n===e)}),df.visible=e===`watch`&&Z.step>=ku(),Lf.visible=e===`camera`&&Z.step>=ku(),cp.visible=e===`music-box`&&Z.step>=ku()}var gp=new oi({color:16770202,transparent:!0,opacity:.7,depthWrite:!1}),_p=new q(new la(1.65,.035,8,64),gp);_p.rotation.x=Math.PI/2,_p.position.y=1.12,_p.visible=!1,$.add(_p);var vp=new q(new sa(.68,.84,40),gp);vp.rotation.x=-Math.PI/2,vp.position.y=1.13,vp.visible=!1,$.add(vp);var yp=new q(new la(.62,.025,8,44),gp);yp.rotation.x=Math.PI/2,yp.scale.set(1.35,1,.72),yp.position.set(.55,1.14,-.45),yp.visible=!1,$.add(yp);var bp=new q(new ji(.56,.56,1.48,30),gp);bp.rotation.x=Math.PI/2,bp.position.set(-1.72,.88,0),bp.visible=!1,$.add(bp);var xp=new q(new J(1.8,.035,1.88),gp);xp.position.set(.35,.91,0),xp.visible=!1,$.add(xp);var Sp=new q(new J(1.82,.035,1.82),gp);Sp.position.copy(Of.position),Sp.position.y=.94,Sp.visible=!1,$.add(Sp);var Cp=new q(new ji(.57,.57,2.5,32),gp);Cp.rotation.z=Math.PI/2,Cp.position.set(-.35,1.05,-.4),Cp.visible=!1,$.add(Cp);var wp=new q(new J(.13,.035,1.2),gp);wp.position.set(.25,1.04,.82),wp.visible=!1,$.add(wp),Pd($);var Tp=new U(0,.9,0),Ep=new U(0,1.02,0),Dp=new U(.55,1.05,-.45),Op=new U(5,.55,-1.15),kp=new U(5,.55,1),Ap=new U(.95,1.05,-.76),jp=new U(-1.72,.92,0),Mp=new U(5,.72,.95),Np=new U(.35,.98,0),Pp=new U(5,.68,-1.05),Fp=new U(.35,.9,.36),Ip=new U(.35,.9,0),Lp=new U(-.35,1.18,-.4),Rp=new U(5,.82,.85),zp=new U(.25,1.03,1.08),Bp=new U(.25,1.03,.82),Vp=new U(0,.86,0),Hp=new U(2.9,.72,-.9),Up=new U(1.18,1.18,-.4),Wp=new U(4.75,.72,-1.5),Gp=new U(.25,1.03,.82),Kp=new U(4.7,.72,-1.45),qp=new Map;function Jp(e,t,n){let r=qp.get(e);if(!(r&&r.to.distanceToSquared(t)<1e-4)){if(e.position.distanceToSquared(t)<1e-4){e.position.copy(t),qp.delete(e);return}qp.set(e,{object:e,from:e.position.clone(),to:t.clone(),progress:0,spinningParts:n})}}function Yp(){qp.forEach((e,t)=>{let n=Z.settings.reduceMotion?1:.055;e.progress=Math.min(1,e.progress+n);let r=1-(1-e.progress)**3;e.object.position.lerpVectors(e.from,e.to,r),e.object.position.y+=Math.sin(e.progress*Math.PI)*.55,e.spinningParts.forEach(e=>{e.rotation.y+=.34}),e.progress>=1&&(e.object.position.copy(e.to),qp.delete(t))})}var Xp=0,Zp=!1,Qp=null;function $p(){return{watch:[Wd,Zd,$d,af,ef,$d,Zd,Z.coverClosed?sf:Wd],camera:[Wd,Tf,Of,Ef,Nf,jf,Af,Ef,Of,Tf,Z.coverClosed?dp:Wd],"music-box":[Wd,Yf,qf,$f,ip,rp,ep,$f,qf,Yf,Z.coverClosed?fp:Wd]}[Z.levelId][Z.step]??null}function em(e){Qp=e,[Wd,Zd,$d,af,ef,Tf,Of,Ef,Nf,jf,Af,Yf,qf,$f,ip,rp,ep,...Object.values(mp)].forEach(e=>e.scale.set(1,1,1))}function tm(){let e=yu[Z.levelId],t=ku(),n=t-1,r=Math.max(0,Math.min(Z.step,t));r<n&&(Z.coverClosed=!1),r>=t&&(Z.coverClosed=!0),Xp=r>=1&&r<t&&!Z.coverClosed?1.72:0,Zd.position.copy(r>=2&&r<7?Op:Tp),$d.position.copy(r>=3&&r<6?kp:Ep),ef.position.copy(r>=5?Dp:Ap);let i=r>=1&&r<t&&!Z.coverClosed,a=Z.levelId===`watch`&&i;af.visible=a&&r<4,_p.visible=Z.levelId===`watch`&&r===6,vp.visible=Z.levelId===`watch`&&r===5,yp.visible=Z.levelId===`watch`&&r===4,Bd.visible=a,Vd.visible=a,Zd.visible=a,$d.visible=a,ef.visible=a;let o=Z.levelId===`camera`&&i;Cf.visible=o,Tf.visible=o,Jp(Tf,r>=2&&r<10?Hp:Vp,[...Tf.children]),Of.visible=o,Of.position.copy(r>=3&&r<9?Pp:Np),Ef.visible=o,Ef.position.copy(r>=4&&r<8?Mp:jp),jf.visible=o,jf.position.copy(r>=6?Ip:Fp),Nf.visible=o&&r<5,Af.visible=o,bp.visible=Z.levelId===`camera`&&r===7,xp.visible=Z.levelId===`camera`&&r===5,Sp.visible=Z.levelId===`camera`&&r===8;let s=Z.levelId===`music-box`&&i;Gf.visible=s,Yf.visible=s,Jp(Yf,r>=2&&r<10?Wp:Up,[...Yf.children]),qf.visible=s,qf.position.copy(r>=3&&r<9?Rp:Lp),Qf.visible=s,$f.visible=s,Jp($f,r>=4&&r<8?Kp:Gp,[...$f.children]),ep.visible=s,rp.visible=s,rp.position.copy(r>=6?Bp:zp),rp.rotation.y=r>=6?0:-.38,ip.visible=s&&r<5,Cp.visible=Z.levelId===`music-box`&&r===8,wp.visible=Z.levelId===`music-box`&&r===5,Wd.visible=r<t,hp();let c=Z.levelId===`watch`?3:4;Q.brush.disabled=r!==c,Q.screwdriver.disabled=(Z.levelId!==`camera`||r!==1&&r!==9)&&(Z.levelId!==`music-box`||r!==3&&r!==7),Q.tweezers.disabled=Z.levelId!==`music-box`||r!==1&&r!==9,Q.cloth.disabled=Z.levelId!==`camera`&&Z.levelId!==`music-box`||r!==6,Iu();let l=r===n&&!Z.coverClosed?e.closeCopy:e.stepCopy[Math.min(r,n)];Q.chapterTitle.textContent=e.title,Q.stepCount.textContent=r>=t?`修理完成`:`步骤 ${r+1} / ${t}`,Q.stepTitle.textContent=r>=t?`修理完成`:l[0],Q.instruction.textContent=r>=t?e.completeInstruction:l[1],em(null),Z.hintLevel=0,Z.lastActivity=Date.now(),Ku()}function nm(e,t=!0){let n=ku();e===n-1&&(Z.coverClosed=!1),e>=n&&(Z.coverClosed=!0),Z.step=Math.max(0,Math.min(e,n)),Z.selectedTool=null,tm(),Ru(),Gu(Z.step>=n?`finish`:`ok`),t&&Z.step<n&&Uu(`很好，零件已经稳定下来。`),Z.step>=n&&(Zp=!0,window.setTimeout(()=>{Vu(`ending`),Ru()},Z.settings.reduceMotion?100:1500))}function rm(e){let t=Cu({step:Z.step,coverClosed:Z.coverClosed},e,Z.levelId);if(!t.accepted)return!1;let n=t.state.step!==Z.step;return Z.step=t.state.step,Z.coverClosed=t.state.coverClosed,Z.selectedTool=null,tm(),Ru(),Gu(t.completed?`finish`:`ok`),n&&!t.completed&&Uu(`很好，零件已经稳定下来。`),t.completed&&(Zp=!0,window.setTimeout(()=>{Vu(`ending`),Ru()},Z.settings.reduceMotion?100:1500)),!0}function im(e=!1){Yu.position.copy(Xu),Qu.target.copy(Zu),Qu.update(),e||Uu(`观察视角已复位。`)}var am=new To,om=new H,sm=new Ir(new U(0,1,0)),cm=new U,lm=new U,um=null;function dm(e){let t=Q.canvas.getBoundingClientRect();om.x=(e.clientX-t.left)/t.width*2-1,om.y=-(e.clientY-t.top)/t.height*2+1,am.setFromCamera(om,Yu)}function fm(e,t){let n=Q.canvas.getBoundingClientRect();om.x=(e-n.left)/n.width*2-1,om.y=-(t-n.top)/n.height*2+1,am.setFromCamera(om,Yu);let r=gm()[0];if(!r)return null;let i=_m(r.object);return i?i.userData.partName:null}function pm(e,t){if(!t)return!1;if(e===`brush`){let e=Z.levelId===`watch`?`dust`:Z.levelId===`camera`?`camera-dust`:`music-dust`,n=Z.levelId===`watch`?3:4;return t===e&&Z.step===n}return e===`screwdriver`?Z.levelId===`camera`&&t===`camera-screws`&&(Z.step===1||Z.step===9)||Z.levelId===`music-box`&&t===`music-comb-screws`&&(Z.step===3||Z.step===7):e===`tweezers`?Z.levelId===`music-box`&&t===`music-pin`&&(Z.step===1||Z.step===9):e===`cloth`&&(Z.levelId===`camera`&&t===`camera-lens`&&Z.step===6||Z.levelId===`music-box`&&t===`music-governor`&&Z.step===6)}function mm(e){kd=e.pointerType!==`touch`,dm(e);let t=new U(om.x,om.y,.15).unproject(Yu).sub(Yu.position).normalize();if(Od.copy(Yu.position).add(t.multiplyScalar(6.2)),Z.selectedTool){let e=gm()[0],t=e?_m(e.object):null;Fu(pm(Z.selectedTool,t?t.userData.partName:null))}}function hm(e){let t=e;for(;t;){if(!t.visible)return!1;t=t.parent}return!0}function gm(){return am.intersectObjects($.children,!0).filter(e=>hm(e.object))}function _m(e){let t=e;for(;t;){if(t.userData.interactiveRoot)return t.userData.interactiveRoot;if(t.userData.partName)return t;t=t.parent}return null}function vm(e,t){if(Z.levelId===`watch`){if(Z.step===1&&t===`ring`)return{root:e,name:t,start:Tp.clone(),target:Op.clone(),radius:1.35};if(Z.step===2&&t===`gear`)return{root:e,name:t,start:Ep.clone(),target:kp.clone(),radius:1.35};if(Z.step===4&&t===`spring`)return{root:e,name:t,start:Ap.clone(),target:Dp.clone(),radius:.72};if(Z.step===5&&t===`gear`)return{root:e,name:t,start:kp.clone(),target:Ep.clone(),radius:.85};if(Z.step===6&&t===`ring`)return{root:e,name:t,start:Op.clone(),target:Tp.clone(),radius:.9}}if(Z.levelId===`camera`){if(Z.step===2&&t===`camera-pressure`)return{root:e,name:t,start:Np.clone(),target:Pp.clone(),radius:1.35};if(Z.step===3&&t===`camera-spool`)return{root:e,name:t,start:jp.clone(),target:Mp.clone(),radius:1.35};if(Z.step===5&&t===`camera-curtain`)return{root:e,name:t,start:Fp.clone(),target:Ip.clone(),radius:.72};if(Z.step===7&&t===`camera-spool`)return{root:e,name:t,start:Mp.clone(),target:jp.clone(),radius:.95};if(Z.step===8&&t===`camera-pressure`)return{root:e,name:t,start:Pp.clone(),target:Np.clone(),radius:.95}}if(Z.levelId===`music-box`){if(Z.step===2&&t===`music-cylinder`)return{root:e,name:t,start:Lp.clone(),target:Rp.clone(),radius:1.35};if(Z.step===5&&t===`music-tine`)return{root:e,name:t,start:zp.clone(),target:Bp.clone(),radius:.65};if(Z.step===8&&t===`music-cylinder`)return{root:e,name:t,start:Rp.clone(),target:Lp.clone(),radius:.95}}return null}function ym(e,t=`现在还不是操作这个部件的时候。`){if(Z.lastActivity=Date.now(),Gu(`wrong`),Uu(t),e){let t=e.rotation.y;e.rotation.y=t-.08,window.setTimeout(()=>{e.rotation.y=t+.08},80),window.setTimeout(()=>{e.rotation.y=t},160)}}function bm(e,t){if(t===`cover`){if(Z.step===0)return rm(`open-cover`),!0;if(Z.step===Au()&&!Z.coverClosed)return rm(`close-cover`),Uu(`${yu[Z.levelId].objectName}已经合好，可以进行最后测试。`),!0}let n=Z.levelId===`watch`?`dust`:Z.levelId===`camera`?`camera-dust`:`music-dust`,r=Z.levelId===`watch`?3:4;return t===n&&Z.step===r?Z.selectedTool===`brush`?(Md(`brush`),rm(`clean-dust`),!0):(ym(e,`先从左侧工具栏拿起软刷。`),!0):Z.levelId===`camera`&&t===`camera-screws`&&(Z.step===1||Z.step===9)?Z.selectedTool===`screwdriver`?(Md(`screwdriver`),rm(Z.step===1?`loosen-screws`:`tighten-screws`),!0):(ym(e,`先从左侧工具栏拿起螺丝刀。`),!0):Z.levelId===`camera`&&t===`camera-lens`&&Z.step===6?Z.selectedTool===`cloth`?(Md(`cloth`),rm(`clean-lens`),!0):(ym(e,`先从左侧工具栏拿起擦拭布。`),!0):Z.levelId===`music-box`&&t===`music-pin`&&(Z.step===1||Z.step===9)?Z.selectedTool===`tweezers`?(Md(`tweezers`),rm(Z.step===1?`release-pin`:`secure-pin`),!0):(ym(e,`先从左侧工具栏拿起镊子。`),!0):Z.levelId===`music-box`&&t===`music-comb-screws`&&(Z.step===3||Z.step===7)?Z.selectedTool===`screwdriver`?(Md(`screwdriver`),rm(Z.step===3?`loosen-comb`:`tighten-comb`),!0):(ym(e,`先从左侧工具栏拿起螺丝刀。`),!0):Z.levelId===`music-box`&&t===`music-governor`&&Z.step===6?Z.selectedTool===`cloth`?(Md(`cloth`),rm(`oil-governor`),!0):(ym(e,`先从左侧工具栏拿起擦拭布。`),!0):t===`crown`&&Z.step===Au()&&Z.coverClosed?(rm(`test-crown`),!0):!1}Q.canvas.addEventListener(`pointerdown`,e=>{if(Z.screen!==`workshop`||!Q.pauseModal.hidden||!Q.settingsModal.hidden)return;mm(e);let t=gm(),n=t.length>0?_m(t[0].object):null;if(!n)return;e.stopImmediatePropagation();let r=n.userData.partName;if(Z.lastActivity=Date.now(),bm(n,r)){e.preventDefault();return}let i=vm(n,r);if(i){if(um=i,Qu.enabled=!1,sm.constant=-n.getWorldPosition(new U).y,am.ray.intersectPlane(sm,cm)){let e=$.worldToLocal(cm.clone());lm.copy(n.position).sub(e)}Q.canvas.setPointerCapture(e.pointerId),e.preventDefault();return}r!==`body`&&ym(n)},{capture:!0}),Q.canvas.addEventListener(`pointermove`,e=>{if(mm(e),um&&(e.stopImmediatePropagation(),am.ray.intersectPlane(sm,cm))){let e=$.worldToLocal(cm.clone()).add(lm),t=window.innerWidth/Math.max(window.innerHeight,1)<.78;um.root.position.x=Ot.clamp(e.x,-2.8,t?2.8:5.5),um.root.position.z=Ot.clamp(e.z,-3,t?5.5:3),um.root.position.y=um.start.y+.25}},{capture:!0}),Q.canvas.addEventListener(`pointerenter`,e=>mm(e)),Q.canvas.addEventListener(`pointerleave`,()=>{kd=!1,Fu(!1)});function xm(){if(!um)return;let{root:e,target:t,start:n}=um,r=Math.hypot(e.position.x-t.x,e.position.z-t.z)<=um.radius;if(um=null,Qu.enabled=!!(Z.screen===`workshop`&&Q.pauseModal.hidden&&Q.settingsModal.hidden),r){let t={watch:{1:`remove-ring`,2:`remove-gear`,4:`fix-spring`,5:`restore-gear`,6:`restore-ring`},camera:{2:`remove-pressure`,3:`remove-spool`,5:`align-curtain`,7:`restore-spool`,8:`restore-pressure`},"music-box":{2:`remove-cylinder`,5:`align-tine`,8:`restore-cylinder`}}[Z.levelId][Z.step];(!t||!rm(t))&&(e.position.copy(n),ym(e))}else e.position.copy(n),ym(e,`这里不能固定这个零件，它已回到安全位置。`)}Q.canvas.addEventListener(`pointerup`,e=>{um&&(e.stopImmediatePropagation(),Q.canvas.hasPointerCapture(e.pointerId)&&Q.canvas.releasePointerCapture(e.pointerId),xm())},{capture:!0}),Q.canvas.addEventListener(`pointercancel`,()=>{um&&um.root.position.copy(um.start),um=null,Qu.enabled=Z.screen===`workshop`}),Q.canvas.addEventListener(`contextmenu`,e=>e.preventDefault());function Sm(){let e=window.innerWidth,t=window.innerHeight,n=e/Math.max(t,1)<.78;qu.setSize(e,t,!1),Yu.aspect=e/Math.max(t,1),n?($.position.set(.45,0,-1.55),rd.position.set(.45,.08,3.25),Op.set(-.58,.55,4.8),kp.set(.58,.55,4.8),Xu.set(.45,16.2,19.2),Zu.set(.45,.18,.75)):($.position.set(-.65,0,0),rd.position.set(4.35,.08,.15),Op.set(5,.55,-1.15),kp.set(5,.55,1),Xu.set(0,8.6,10.8),Zu.set(.5,.25,0)),um||(tm(),Yu.position.copy(Xu),Qu.target.copy(Zu),Qu.update()),Yu.updateProjectionMatrix()}window.addEventListener(`resize`,Sm),Sm();var Cm=new Oo;function wm(){requestAnimationFrame(wm);let e=Cm.getElapsedTime(),t=Z.settings.reduceMotion?1:.11;if(Wd.rotation.z=Ot.lerp(Wd.rotation.z,Xp,t),Yp(),Nd(),Qp){let t=1+Math.sin(e*5)*.035;Qp.scale.set(t,t,t)}$d.rotation.y+=Z.step>=ku()?.025:0,Zp&&(hf.rotation.y=e*1.8,mf.rotation.y=e*.28),Qu.update(),qu.render(Ju,Yu)}wm();function Tm(){Q.volume.value=String(Z.settings.volume),Q.reduceMotion.checked=Z.settings.reduceMotion,Q.autoHint.checked=Z.settings.autoHint,document.body.classList.toggle(`reduce-motion`,Z.settings.reduceMotion)}function Em(){let e=yu[Z.levelId];Q.letterDate.textContent=e.letterDate,Q.letterTitle.textContent=e.title,Q.letterBody.replaceChildren(...e.letter.map(e=>{let t=document.createElement(`p`);return t.textContent=e,t})),Q.letterSignature.textContent=e.signature,Q.enterWorkshop.textContent=e.enterLabel,Q.endingTitle.textContent=e.endingTitle,Q.endingQuote.textContent=e.endingQuote,Q.endingBody.replaceChildren(...e.endingStory.map(e=>{let t=document.createElement(`p`);return t.textContent=e,t}))}function Dm(){Q.pauseModal.hidden=!0,Q.settingsModal.hidden=!1,Qu.enabled=!1,Tm()}function Om(){Q.settingsModal.hidden=!0,Qu.enabled=Z.screen===`workshop`,Z.settings={volume:Number(Q.volume.value),reduceMotion:Q.reduceMotion.checked,autoHint:Q.autoHint.checked},document.body.classList.toggle(`reduce-motion`,Z.settings.reduceMotion),zu()}function km(e=Z.levelId){Z.levelId=e,Z.step=0,Z.coverClosed=!1,Z.selectedTool=null,Zp=!1,Em(),tm(),Ru(),Vu(`letter`)}function Am(){let e=Lu();e&&(Z.settings={...wu,...e.settings},Z.levelId=e.levelId,Tm(),Em(),Z.step=Math.max(0,Math.min(e.step??0,ku())),Z.coverClosed=!!e.coverClosed,tm(),e.completed?Vu(`ending`):Vu(`workshop`))}function jm(){let e=yu[Z.levelId];Z.lastActivity=Date.now(),Z.hintLevel=Math.min(3,Z.hintLevel+1);let t=[`留意正在轻微呼吸的 3D 部件。`,Z.step===Au()&&!Z.coverClosed?e.closeCopy[1]:e.stepCopy[Math.min(Z.step,Au())][1],Z.step===Au()&&!Z.coverClosed?`直接答案：${e.closeCopy[0]}，再完成测试。`:`直接答案：完成“${e.stepCopy[Math.min(Z.step,Au())][0]}”。`];em($p()),Uu(t[Z.hintLevel-1])}document.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-action]`)?.dataset.action;n&&{"retry-load":()=>{Vu(`loading`),window.setTimeout(()=>Vu(`home`),550)},home:()=>{Vu(`home`),Bu()},"new-game":()=>{let e=t.closest(`[data-level]`)?.dataset.level;km(bu(e)?e:`watch`)},continue:Am,"enter-workshop":()=>{tm(),im(!0),Vu(`workshop`)},settings:Dm,"close-settings":Om,pause:()=>{Q.pauseModal.hidden=!1,Qu.enabled=!1},resume:()=>{Q.pauseModal.hidden=!0,Qu.enabled=!0},"pause-home":()=>{Q.pauseModal.hidden=!0,Ru(),Vu(`home`)},"confirm-restart":()=>{Q.pauseModal.hidden=!0,Q.confirmModal.hidden=!1},"cancel-restart":()=>{Q.confirmModal.hidden=!0,Q.pauseModal.hidden=!1},restart:()=>{Q.confirmModal.hidden=!0,Q.pauseModal.hidden=!0,km()},hint:jm,"reset-camera":im,"finish-home":()=>{Ru(),Vu(`home`),Bu()}}[n]?.()}),document.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-tool]`)?.dataset.tool;if(n&&!t.closest(`[data-tool]`)?.disabled){if(n===`brush`){let e=Z.levelId===`watch`?3:4;if(Z.step!==e){Uu(`当前阶段还用不到软刷。`);return}Z.selectedTool=Z.selectedTool===`brush`?null:`brush`,Iu(),Uu(Z.selectedTool?`软刷已拿起。现在点击${yu[Z.levelId].objectName}里的积尘。`:`软刷已放回工具架。`)}if(n===`screwdriver`||n===`tweezers`||n===`cloth`){let e=n;Z.selectedTool=Z.selectedTool===e?null:e,tm(),Z.selectedTool?Uu(e===`screwdriver`?`螺丝刀已拿起。点击银色固定螺丝。`:e===`tweezers`?`镊子已拿起。点击红色定位销。`:`擦拭布已拿起。点击需要清洁或润滑的部位。`):Uu(e===`screwdriver`?`螺丝刀已放回工具架。`:e===`tweezers`?`镊子已放回工具架。`:`擦拭布已放回工具架。`)}n===`inspect`&&(Z.selectedTool=null,Iu(),Q.inspect.classList.add(`active`),window.setTimeout(()=>Q.inspect.classList.remove(`active`),600),Uu(`拖动工作台空白处旋转，滚轮或双指缩放。`))}}),document.addEventListener(`change`,e=>{let t=e.target;[`volume`,`reduce-motion`,`auto-hint`].includes(t.id)&&(Z.settings={volume:Number(Q.volume.value),reduceMotion:Q.reduceMotion.checked,autoHint:Q.autoHint.checked},document.body.classList.toggle(`reduce-motion`,Z.settings.reduceMotion),zu())}),document.addEventListener(`click`,e=>{let t=e.target.closest(`[data-debug]`)?.dataset.debug;t&&(t===`next`&&(Vu(`workshop`),nm(Z.step+1,!1)),t===`previous`&&(Vu(`workshop`),nm(Z.step-1,!1)),t===`load-error`&&Vu(`load-error`),t===`context-loss`&&Uu(`渲染被暂停时，正式版本将保存状态并尝试恢复 WebGL 上下文。`),t===`reset`&&(Ou.clear(),Z.step=0,Z.coverClosed=!1,Z.settings={...wu},Tm(),tm(),Bu(),Vu(`home`),Uu(`3D 原型状态已清空。`)))}),document.addEventListener(`visibilitychange`,()=>{document.hidden&&Z.screen===`workshop`?(Qu.enabled=!1,Uu(`工作台已自动暂停。`)):Z.screen===`workshop`&&Q.pauseModal.hidden&&(Qu.enabled=!0)}),window.setInterval(()=>{Z.screen!==`workshop`||!Z.settings.autoHint||Z.hintLevel>0||Date.now()-Z.lastActivity>25e3&&jm()},2e3);var Mm=Lu();Mm?.settings&&(Z.settings={...wu,...Mm.settings},Z.levelId=Mm.levelId),Tm(),Em(),Bu(),tm(),window.setTimeout(()=>Vu(`home`),750);function Nm(e){let t=e.clone().project(Yu),n=Q.canvas.getBoundingClientRect();return{x:n.left+(t.x+1)*n.width/2,y:n.top+(1-t.y)*n.height/2}}function Pm(e){return e===`ring`?new U(1.65,0,0):e===`spring`?new U(0,0,-.56):e===`camera-spool`?new U(0,0,.45):e===`camera-pressure`?new U(.75,0,0):e===`music-cylinder`?new U(.45,0,0):e===`crown`&&Z.levelId===`music-box`?new U(.32,0,0):new U}function Fm(e){return e===`cover`?Z.levelId===`watch`?Gd:Z.levelId===`camera`?Ff:op:e===`ring`?Zd:e===`gear`?$d:e===`spring`?ef:e===`dust`?af.children[0]??af:e===`camera-screws`?Tf.children[0]??Tf:e===`camera-pressure`?Of:e===`camera-spool`?Ef:e===`camera-dust`?Nf.children[0]??Nf:e===`camera-curtain`?jf:e===`camera-lens`?Af:e===`music-pin`?Yf:e===`music-cylinder`?qf:e===`music-comb-screws`?$f.children[0]??$f:e===`music-dust`?ip.children[0]??ip:e===`music-tine`?rp:e===`music-governor`?ep:e===`crown`?mp[Z.levelId]:Id}function Im(e){let t=Fm(e),n=Pm(e);return Nm(t.localToWorld(n.clone()))}function Lm(e){let t=vm(Fm(e),e);if(!t)return null;let n=Pm(e),r=$.localToWorld(t.target.clone().add(n));return{start:Im(e),end:Nm(r)}}window.__oldObject3DPrototype={getState:()=>({...Z,settings:{...Z.settings}}),goToStep:e=>{Vu(`workshop`),nm(e,!1)},showScreen:Vu,resetCamera:()=>im(),partPoint:Im,dragPoints:Lm,hitAt:fm,coverClearance:()=>new Xn().setFromObject(Wd).min.y,isPartVisible:e=>hm(Fm(e)),heldToolState:()=>({visible:Td.visible,tool:jd(),targetValid:Pu}),partWorldPosition:e=>{let t=Fm(e).getWorldPosition(new U);return{x:t.x,y:t.y,z:t.z}}};